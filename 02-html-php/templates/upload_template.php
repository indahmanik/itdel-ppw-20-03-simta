...
<html lang="en">
  <head>
    ...
    <title>Upload Document Tugas Akhir</title>
  </head>
  <body>
	<section>
    ...
    <div class="row no-gutters">
        <div class="col-md-2" style="background-color: #dedede;">
            ...
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical" style="text-align: center;">
                ...
                <a class="nav-link active" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Upload</a>
            ...
            <div class="row no-gutters">
                ...
                {% for ev in event %}
                  ...
                  <p class="card-text" style="font-size: 14px; text-align: right; color: #193Abf;">{{ev['date']}}</p>
                {% endfor %}
                </div>
            </div>
        </div>
          ...
          <br>
            <h3 style="font-family:'Times New Roman', Times, serif;  text-align: center; color:#193Abf">Tasks</h3><hr>
              ...
              <table class="table">
                    <thead>
                        <tr>
                            <h4 style="font-family:'Times New Roman', Times, serif; color:#193Abf"><u>Task 1</u></h4>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="font-family: bookman;">Submission status</td>
                            <td style="font-family: bookman;">No attempt</td>
                        </tr>
	                    <tr>
                            <td style="font-family: bookman;">Due date</td>
                            <td style="font-family: bookman;">Friday, 18 September 2020, 10.00 PM</td>
                            <td>  
                              <form action="submit.php">
                                <button type="submit" class="btn btn-primary btn-md" style="width: 100px;">Upload</button>
                              </form>
                            </td>
                        </tr> 
                        <tr class="table-danger">
                            <td style="font-family: bookman;">Time remaining</td>
                            <td style="font-family: bookman;">23 hours 18 mins</td>
                        </tr>
                    </tbody>
                </table><br>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            <h4 style="font-family:'Times New Roman', Times, serif; color:#193Abf"><u>Task 2</u></h4>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            <td style="font-family: bookman;">Due date</td>
                            <td style="font-family: bookman;">Friday, 18 September 2020, 11.00 PM</td>
                            <td>  
                              <form action="submit.php">
                                <button type="submit" class="btn btn-primary btn-md" style="width: 100px;">Upload</button>
                              </form>
                        ...
                        <tr class="table-danger">
                            <td style="font-family: bookman;">Time remaining</td>
                            <td style="font-family: bookman;">24 hours 18 mins</td>
                        </tr>
                    </tbody>
                </table><br>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            <h4 style="font-family:'Times New Roman', Times, serif; color:#193Abf"><u>Task 3</u></h4>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
	                    ...
	                    <tr>
                            <td style="font-family: bookman;">Due date</td>
                            <td style="font-family: bookman;">Friday, 19 September 2020, 10.00 PM</td>
                            <td>
                              <form action="submit.php">
                              <button type="submit" class="btn btn-primary btn-md" style="width: 100px;">Upload</button></td>
                              </form>
                        </tr> 
          
                        <tr class="table-danger">
                            <td style="font-family: bookman;">Time remaining</td>
                            <td style="font-family: bookman;">1 Days 23 hours 18 mins</td>
                        </tr>
                    </tbody>
                </table>
        </div>
