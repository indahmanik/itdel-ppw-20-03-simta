...
<html lang="en">
  <head>
    ...
    <title>Submission Document Tugas Akhir</title>
    <style>
		footer {
			padding: 5px;
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <form class="form-inline" style="margin-left: auto;">
            <p style= "padding-right: 30px; padding-top: 10px; font-size: 25px;">Hello, {{user}}!</p>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-8">
            ...
            <form id="box" method="POST" action="proses_submit.php" enctype="multipart/form-data">
		     Upload File :
