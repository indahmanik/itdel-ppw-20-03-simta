...
<body style="background-color:#F7F7F7">
    ...
    <!-- Brand -->
    <a class="navbar-brand" href="/indexd">SIMTA 03</a></a>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
            <a class="nav-link" href="/indexd">Home</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="/forum">Forum</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="/artefakd">Artefak</a>
            </li>
            <li class="nav-item">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="/reviewdoc">
                ...
                <a class="dropdown-item" href="/listTask">
                ...
                <a class="dropdown-item" href="/addscore">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 0h5.5v1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h1V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2z"/>
                    <path d="M9.5 3V0L14 4.5h-3A1.5 1.5 0 0 1 9.5 3z"/>
                    <path fill-rule="evenodd" d="M8 6.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 .5-.5z"/>
        ...
        <li class="nav-item dropdown">
            ...
            <li class="nav-item">
                <a class="nav-link p-2" href="/settingsd" rel="noopener" aria-label="Settings">
