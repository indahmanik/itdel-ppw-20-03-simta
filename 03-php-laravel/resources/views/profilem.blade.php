              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <!-- <img src="{{ $stu->img }}" alt="Admin" class="rounded-circle" width="150"> -->
                    <img src="{{ $stu->img }}" width="150px" height="150px" style="float:left; border-radius:20%; object-fit:cover">
                    <div class="mt-3">
                      <h4>{{ $stu->name }}</h4>
                      <p class="text-secondary mb-1">Student of {{ $stu->batch }}</p>
                      <p class="text-muted font-size-sm">{{ $stu->email }}</p>
                      <form class="form-inline" action="/settingsm" style="margin-left: 45px">
                      ...
                      <br>
                        ...
                        <table class="table table-bordered" style="margin-top:-25px">
                          <thead class="thead-light">
                            <tr>
                              <th scope="col" colspan="2" width="99px" style="text-align:right">Jumlah</th>
                              <th>{{$sum}}</th>
                            </tr>
                            <tr>
                              <th scope="col" colspan="2" width="99px" style="text-align:right">Rata-rata</th>
                              <th>{{$sc}}</th>
                            </tr>
                          </thead>
                        </table>
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form method="post" action="/profilem/addeventm">
                                          @csrf
                            ...
                            @foreach($event as $event)
                              <li>
                                  ...
                                  <p class="text-muted">Team {{$event->team_id}} : {{$event->description}}
                                    <span class="float-right text-muted">
                                      <a href="/profilem/edit/{{$event->id_event}}" class="badge badge-info">Edit</a>
                                      <a href="/profilem/delete/{{ $event->id_event }}" class="badge badge-danger">Delete</a>
                                    </span>
                                  </p>                                  
                              </li>
                            @endforeach
